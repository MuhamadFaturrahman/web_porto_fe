...
const SkillsCard: React.FC<CardDetails> = ({ id, title, image, description }) => {
  return (
    ...
    <button className='flex md:mt-auto items-center justify-center space-x-2 rounded-md px-6 py-3 shadow-lg bg-white bg-opacity-5 border-2 border-[#18A4E0] hover:bg-[#18A4E0] text-[#18A4E0] hover:text-[#FAF8F0] transition duration-300 ease-in-out w-full'>
